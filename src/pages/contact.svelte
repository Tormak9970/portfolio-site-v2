...
<style>
    ...
    #infoSection .info-container .blurb .email-link:hover { color: var(--highlight-hover); }
    ...
    #infoSection .info-container .form-wrapper #contactForm label { width: calc(100% - 10px); font-size: 18px; }
    ...
    #infoSection .info-container .form-wrapper #contactForm input:focus { outline: 1px solid var(--highlight); }
    ...
    #infoSection .info-container .form-wrapper #contactForm textarea:focus { outline: 1px solid var(--highlight); }
    ...
    #infoSection .info-container .form-wrapper #contactForm button:hover { background-color: var(--highlight-hover); }
    #infoSection .info-container .form-wrapper #contactForm button:focus { outline: none;}
    ...
    #infoSection .breadcrump-cont #breadCrumbCont { font-size: 14px; }

    #infoSection .hidden { bottom: -40px; }
</style>